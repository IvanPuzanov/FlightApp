...
final class HomeFlightListMapButton: UIView {
...
extension HomeFlightListMapButton: ConfigurableView {

    func configure(with configuration: HomeFlightListMapButtonConfiguration) {
